...
class port():
    ...
    def importData(self):
        geoData = open("TestingCoord.csv", "r")          
    ...
    def testTransformation(self):
        ...
        for n in range(len(self.portData)):
            ...
            degreeX = int(self.portData[n][2][0:indexX])
        ...
        for n in range(len(self.portData)):
            ...
            degreeY = int(self.portData[n][1][0:indexY])
        ...
        for n in range(len(x)):
            self.x2.append(600-((x[n]/20037500)*1200))
            self.y2.append(350-((y[n]/20037500)*700))
